# NotifyMe QR Trace Upload Web App
...
This Web App is used for uploading trace keys to the [backend](https://github.com/notifyme-app/notifyme-sdk-backend).
...
***Note:***
`POST_URL` needs to be configured to your [backend](https://github.com/notifyme-app/notifyme-sdk-backend) traceKey POST endpoint.
